    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        coreapp.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        coreapp.notify('Has an error', 'error');
                        coreapp.stopLoading();
                    }
                });
                return false;
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    coreapp.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    coreapp.stopLoading();
                },
                error: function () {
                    coreapp.notify('Has an error in save permission progress', 'error');
                    coreapp.stopLoading();
                }
            });
        });
